...
namespace Bagnardi.Game
{
    ...
    class GameHelper
    {
        ...
        // Modified by Frankie Bagnardi
        public static Color HSLColor(double h, double sl, double l)
        {
            double v;
            double r, g, b;
        ...
        bool IsFirstPress(Buttons button, GamePadState previous, GamePadState current)
        {
        ...
        bool IsRelease(Buttons button, GamePadState previous, GamePadState current)
        {
